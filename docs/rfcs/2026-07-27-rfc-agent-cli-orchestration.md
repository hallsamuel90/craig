...
- `4.1` Add capability-scoped parent/child delegation and tree cancellation: `implemented, project-scope and initial-session hardened, and verified`
...
- Current project-child and initial-session hardening passed with 667 tests across 68 files via `pnpm test`, plus `pnpm typecheck`, `pnpm lint`, `pnpm build`, `pnpm build:npm`, `pnpm package:audit`, and `pnpm package:smoke`.
