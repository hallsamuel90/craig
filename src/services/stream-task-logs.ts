...
import { getTaskOrThrow, resolveTaskLogPath } from "./task-inspection.js";

export async function prepareTaskLogs(
  paths: CraigPaths,
  taskId: string,
...
export async function streamTaskLogs(logPath: string): Promise<void> {
