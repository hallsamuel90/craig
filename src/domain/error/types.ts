export type CraigErrorCode =
  ...
  | "FURY_DEFINITION_INVALID"
  | "FURY_INPUT_INVALID"
  | "FURY_PLAN_NOT_FOUND"
  | "FURY_APPROVAL_REQUIRED"
  | "FURY_RUN_NOT_FOUND"
  | "FURY_REVIEW_NOT_FOUND"
  | "FURY_RECORD_INVALID"
  | "FURY_STATE_CONFLICT"
  | "FURY_OUTPUT_INVALID"
  | "PARTIAL_RESULT"
...
export const CRAIG_EXIT_CODE_BY_ERROR = {
  ...
  FURY_DEFINITION_INVALID: 2,
  FURY_INPUT_INVALID: 2,
  FURY_PLAN_NOT_FOUND: 3,
  FURY_APPROVAL_REQUIRED: 4,
  FURY_RUN_NOT_FOUND: 3,
  FURY_REVIEW_NOT_FOUND: 3,
  FURY_RECORD_INVALID: 2,
  FURY_STATE_CONFLICT: 4,
  FURY_OUTPUT_INVALID: 4,
  PARTIAL_RESULT: 7,
  INTERNAL_ERROR: 1,
